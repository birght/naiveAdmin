...
<script lang="ts" setup>
  ...
  const columns = [
    ...
    { title: '统一企业社会信用代码', key: 'xxm' },
    { title: '药品名称', key: 'dbr' },
    { title: '原药品批准文号/登记号', key: 'address' },
    { title: '申请时间', key: 'ccDate' },
    { title: '审批时间', key: 'ccDate' },
    { title: '审批结果', key: 'levelMsg' },
